        ...
        if (directory.isDirectory()) {
            ...
            while (iterator.hasNext()) {
                ...
                if (isAutoExtra(name2)) {
                    log.info(name2);
                    List<String> filesNameRepeat = new ArrayList<>();
                    filesNameRepeat.add(name2);
                    ...
                    List<File> collect = notDirectoryS.stream().filter(file1 -> {
                        ...
                        String s2 = removeExtra(name2);
                        if(StringUtils.isNotBlank(s2)){
                            String s1 = removeExtra(name1);
                            if(s2.equals(name1) || s2.equals(s1)){
                                return true;
                            }
                        }
                        //if(name1)
